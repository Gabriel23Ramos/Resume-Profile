...
const translations = {
  pt: {
    ...
    proj4Titulo: "Gabriel English Academy",
    proj4Desc: "Landing page para uma escola de inglês: quiz de nível interativo, seção de planos, certificado de conclusão com preview em modal e identidade visual própria construída do zero.",
  ...
  en: {
    ...
    proj4Titulo: "Gabriel English Academy",
    proj4Desc: "Landing page for an English school: interactive level quiz, pricing plans, a completion certificate with a modal preview, and a custom visual identity built from scratch.",
